...
@Generated("")
@Path("/v1.0")
public abstract class BaseCoverupResourceImpl implements CoverupResource {
	...
	@Tags(value = {@Tag(name = "Coverup")})
	public SuperheroObject getAlive() throws Exception {
		return new SuperheroObject();
	}
	...
	@POST
	@Parameters(
		value = {@Parameter(in = ParameterIn.PATH, name = "confirmationId")}
	)
	@Path("/{confirmationId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Coverup")})
	public CoverupObject postConfirmation(
			@NotNull @Parameter(hidden = true) @PathParam("confirmationId")
				Integer confirmationId)
		throws Exception {

		return new CoverupObject();
	}

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/coverup/v1.0/Users/{confirmationId}'  -u 'test@liferay.com:test'
	 */
	@Override
	@POST
	@Parameters(
	...
	@Path("/Users/{confirmationId}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Coverup")})
	public CoverupObject postUserConfirmation(
			@NotNull @Parameter(hidden = true) @PathParam("confirmationId")
				Integer confirmationId)
		throws Exception {
